...
int main()
{
	...
	Goddard_Pata01.LoadModel("Models/goddard_pata_fi.obj");
	Goddard_Pata02 = Model();
	Goddard_Pata02.LoadModel("Models/goddard_pata_fd.obj");
	Goddard_Pata03 = Model();
	Goddard_Pata03.LoadModel("Models/goddard_pata_ti.obj");
	Goddard_Pata04 = Model();
	Goddard_Pata04.LoadModel("Models/goddard_pata_td.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//Cabeza (sin mandíbula)
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.2f, 1.7f, -1.4f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.0f, 0.6f, -0.75f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.4f, 0.0f, -0.75f));
