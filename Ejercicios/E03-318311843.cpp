...
int main()
{
	...
	*/
	...
	camera = Camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.3f/*Velocidad de movimiento*/, 0.75f/*Velocidad de giro*/);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Piso
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(10.0, 0.02f, 10.0f));
		model = glm::translate(model, glm::vec3(0.0f, -14.0f, -0.225f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.72f, 0.48f, 0.34f);
		...
		model = glm::translate(model, glm::vec3(-5.25f, -2.50f, -19.75f));
		...
		model = glm::translate(model, glm::vec3(2.65f, -0.485f, -9.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -115.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		//Techo
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(1.0f, 0.35f, 1.0f));
		model = glm::translate(model, glm::vec3(0.0f, 1.45f, -2.0));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[4]->RenderMeshGeometry();
		...
		model = glm::translate(model, glm::vec3(0.0f, -0.82f, -165.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.01f));
		model = glm::translate(model, glm::vec3(-0.75f, 0.75f, -165.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();
		...
		//Ventana izquierda 01
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(0.01f,0.2f, 0.2f));
		model = glm::translate(model, glm::vec3(-33.0f ,0.75f, -9.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();

		//Ventana izquierda 02
		model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(0.01f, 0.2f, 0.2f));
		model = glm::translate(model, glm::vec3(-33.5f, 0.75f, -10.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();
