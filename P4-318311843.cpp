...
Pasos para determinar el nodo padre

--Eliminar los objetos ubicados en los extremos
--Determinar qué elemento tiene más elementos conectados
--Determinar desde qué nodo es más fácil rotar y trasladar el objeto





Nota: Crear una nueva matriz por cada bifurcación en el árbol jerárquico
*/
#include <stdio.h>
#include <string.h>
#include<cmath>
...
int main()
{
	...
	CrearCilindro(30, 2.0f);//índice 2 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//Llanta 01
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, -3.5f, 3.15f));
		...
		//Llanta 02
		modelaux = model;
		model = glm::translate(model, glm::vec3(2.0f, -3.5f, 3.15f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		*/
		...
		//Parte 2
		modelaux = model;
		model = glm::translate(model, glm::vec3(-4.5f, 8.5f, 0.0f));
		...
		//Articulación oreja 01
		model = glm::translate(model, glm::vec3(-2.0f, 12.0f, -2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getoreja9()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		...
		//Articulación oreja 02
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 4.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getoreja0()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Articulación cadera 01
		model = glm::translate(model, glm::vec3(-2.0f, -15.0f, 3.0f));
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f, 5.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[4]->RenderMesh();
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(4.0f, 6.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[4]->RenderMesh();
		...
		//Articulación cadera 03
		model = glm::translate(model, glm::vec3(-6.0f, 8.0f, -10.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getpata5()), glm::vec3(0.0f, 0.0f, -1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Articulación rodilla 03
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getpata6()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Articulación cadera 04
		model = glm::translate(model, glm::vec3(6.0f, 8.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getpata7()), glm::vec3(0.0f, 0.0f, -1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Articulación rodilla 04
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getpata8()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
